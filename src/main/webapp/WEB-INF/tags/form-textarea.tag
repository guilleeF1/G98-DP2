...
<div class="form-group">
    ...
    <textarea id="${path}" name="${path}" class="form-control" placeholder="${placeholder}" <jstl:if test="${readonly}">readonly</jstl:if>><jstl:out value="${requestScope[path_text]}"/></textarea>
