...
<acme:list readonly="true">
	...
	<acme:list-column code="anonymous.shout.list.label.infosheet.date" path="infosheet.date" width="20%"/>
	<acme:list-column code="anonymous.shout.list.label.infosheet.moment" path="infosheet.moment" width="20%"/>
	<acme:list-column code="anonymous.shout.list.label.infosheet.money" path="infosheet.money" width="10%"/>
	<acme:list-column code="anonymous.shout.list.label.infosheet.flag" path="infosheet.flag" width="10%"/>
</acme:list>
