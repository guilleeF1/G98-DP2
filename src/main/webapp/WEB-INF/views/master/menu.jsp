...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.manager" access="hasRole('Manager')">
			<acme:menu-suboption code="master.menu.manager.task.list" action="/Acme-Planner/manager/task/list"/>
			<acme:menu-separator/>
			<acme:menu-suboption code="master.menu.manager.task.create" action="/Acme-Planner/manager/task/create"/>
		</acme:menu-option> 
	...
	<acme:menu-right>
		...
		<acme:menu-option code="master.menu.user-account" access="isAuthenticated()">
			...
			<acme:menu-suboption code="master.menu.user-account.become-manager" action="/authenticated/Acme-Planner/manager/create" access="!hasRole('Manager')"/>
		</acme:menu-option>
