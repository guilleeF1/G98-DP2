...
public class AnonymousShoutListTest extends AcmePlannerTest {
	...
	// Lifecycle management ---------------------------------------------------
		...
		public void listShoutsWithAnonymous(final int recordIndex, final String moment, final String author, final String text,
			final String date, final String informationSheetMoment, final String money, final String flag) {
			...
			super.checkColumnHasValue(recordIndex, 3, date);
			super.checkColumnHasValue(recordIndex, 4, informationSheetMoment);
