package acme.testing.administrator.shout;
...
public class AdministratorShoutCreateTest extends AcmePlannerTest {
	...
	// Lifecycle management ---------------------------------------------------
		...
		@ParameterizedTest
		@CsvFileSource(resources = "/administrator/shout/create-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
		@Order(10)
		public void createShoutWithAdministratorPositive(final Date moment, final String author, final String text, final String info) {
			...
			super.clickOnMenu("Administrator", "Create a shout");
		...
		@ParameterizedTest
		@CsvFileSource(resources = "/administrator/shout/create-negative.csv", encoding = "utf-8", numLinesToSkip = 1)
		@Order(20)
		public void createShoutWithAdministratorNegative(final Date moment, final String author, final String text, final String info) {
			super.signIn("administrator3", "administrator3");
